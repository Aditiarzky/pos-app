...
import { Trash2, Edit2, Eye, Phone, MapPin, LayoutList } from "lucide-react";
          ...
          <Table>
            <TableHeader className="bg-muted/20 border-t border-b border-border/50">
              <TableRow className="border-none">
                <TableHead className="w-[60px] text-center text-[12px] sm:text-sm h-8 sm:h-10 px-2 sm:px-4 font-semibold text-muted-foreground uppercase tracking-wide">
                  No
                </TableHead>
                ...
                <TableHead className="hidden md:table-cell text-[12px] sm:text-sm h-8 sm:h-10 px-2 sm:px-4 font-semibold text-muted-foreground uppercase tracking-wide">
                  Kontak & Alamat
                </TableHead>
                ...
                <TableHead className="w-[120px] text-right text-[12px] sm:text-sm h-8 sm:h-10 px-2 sm:px-4 font-semibold text-muted-foreground uppercase tracking-wide">
                  Aksi
                </TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {isLoading ? (
                ...
                filteredCustomers.map((c: CustomerResponse, idx: number) => (
                  <TableRow
                    key={c.id}
                    className="group hover:bg-muted/30 transition-colors border-b border-border/30 last:border-none"
                  >
                    {/* Nomor */}
